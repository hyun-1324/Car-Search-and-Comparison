...
func comparisonHandler(w http.ResponseWriter, r *http.Request) {
	...
	addCookieFromManufacturersAndCategoriesInfo(w, r, manufacturerInfo, categoryInfo)
...
func addCookieFromManufacturersAndCategoriesInfo(w http.ResponseWriter, r *http.Request, manufacturerInfo []string, categoryInfo []string) {
